...
export const AddIGCSEClassDialog: React.FC<AddDialogProps> = (props) => {
...
export const EditIGCSEClassDialog: React.FC<EditDialogProps> = (props) => {
  const seasons = ["Feb/Mar", "May/Jun", "Oct/Nov"];
...
export const DeleteIGCSEClassDialog: React.FC<EditDialogProps> = (props) => {
